 ...
 */
async function searchBar(term, options = {
    ...
    try {
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            const id = itemData.urlPath.split("/")[2];
            const poster = itemData.urlCoverOri || `${baseURL}/public-assets/img/no-image.png`;
        ...
        return { url: `${baseURL}/apo/`, valid: true, results };
    }
    catch (e) {
